...
4. The `callback` can be one of:
  ...
  2. A function *(line 5)*.
  3. Any of the acceptable handler arguments that enquire.register() can handle. [See the Enquire.js docs](http://wickynilliams.github.com/enquire.js/) for more info *(lines 6 — 11)*.
